...
        console.log("Fetched published explorations:", fetchedExplorations);
      } catch (error) {
...
  const handleItemClick = async (explorationData) => {
    console.log("Selected exploration:", explorationData);
    
    try {
...
          <li key={item.id} className='explore-item' onClick={() => handleItemClick(item)}>
