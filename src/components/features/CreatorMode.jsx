/**
 * CreatorMode.jsx - Creator application and tools interface
 * 
 * This component provides:
 * - Application form for users who want to become creators
 * - Full creator tools (replica of Admin Tools) for approved creators
 * 
 * The isCreator boolean in Firestore determines if a user has been approved
 * as a creator. Non-creators see the application form, while approved creators
 * see the full creator tools interface.
 */
...
import AdmTools from '../admin/AdmTools.jsx';
import SuggestionsPortal from '../admin/SuggestionsPortal.jsx';
import OSMapAdmin from '../admin/OSMapAdmin.jsx';
 ...
 * 
 * Displays either:
 * 1. Application form for non-creators to apply for creator status
 * 2. Full creator tools (replica of Admin Tools) for approved creators
 * 
 * @param {Object} user - Current authenticated user
 * @param {Object} userDocument - Full user document from Firestore (includes isCreator)
 * @param {string} mapId - Google Maps ID for map styling and configuration
 * @returns {JSX.Element} Creator application form or creator tools interface
 */
function CreatorMode({ mapId, user, userDocument }) {
     ...
     */
    useEffect(() => {
        if (isCreator && !hasShownWelcome) {
            setNotification({
                isVisible: true,
                message: 'Welcome back, Creator! 🎨',
                type: 'success'
            });
            setHasShownWelcome(true);
        }
    }, [isCreator, hasShownWelcome]);
    ...
    if (!isCreator) {
                ...
                <div id="creator-mode">
                    ...
                    <div className="creator-container">
                        <div className="success-message">
                            ...
                            <p>We will review your application and get back to you via email at <strong>{user?.email}</strong>.</p>
                            ...
                            <div className="form-section">
                                ...
                                <div className="form-group">
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        placeholder="Describe your outdoor exploration experience, adventures you've been on, expeditions you've participated in, and what makes you passionate about exploring..."
                                        rows={6}
        ...
        // Show intro screen with "Become a Creator" button
        return (
            <div id="creator-mode">
                <GeometricGrid />
                <div className="creator-header">
                        ...
                        <div className="feature-list">
                            <div className="feature-item">
                                ...
                                <div className="feature-text">
                                    ...
                                    <p>Draw routes on Google Maps or OS Maps with precision tools</p>
                                </div>
                            </div>
                            <div className="feature-item">
                                <div className="feature-icon">
                                ...
                                <div className="feature-text">
                                    ...
                                    <p>Add waypoints with images, descriptions, and audio narration</p>
                                </div>
                            </div>
                            <div className="feature-item">
                                <div className="feature-icon">
                                ...
                                <div className="feature-text">
                                    ...
                                    <p>Publish your adventures for the community to explore and enjoy</p>
                                </div>
                            </div>
                            <div className="feature-item">
                                <div className="feature-icon">
                                ...
                                <div className="feature-text">
                                    <h4>Creator Recognition</h4>
                                    <p>Build your reputation and get recognized for your contributions</p>
                                </div>
                            </div>
                        </div>
    ...
    // ========== RENDER FOR CREATORS (Full Admin-like interface) ==========
    return (
