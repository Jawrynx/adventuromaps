...
const geojsonData = JSON.parse(fs.readFileSync('./public/geodata/convert.geojson', 'utf8'));
...
fs.writeFileSync('./public/geodata/england-aonbs.json', JSON.stringify(convertedGeoJson, null, 2), 'utf8');
